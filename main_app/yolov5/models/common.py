...
from main_app.yolov5.utils.dataloaders import exif_transpose, letterbox
from main_app.yolov5.utils.general import (LOGGER, ROOT, Profile, check_requirements, check_suffix, check_version,
                                              colorstr, increment_path, make_divisible, non_max_suppression, scale_coords, xywh2xyxy, xyxy2xywh, yaml_load)
from main_app.yolov5.utils.plots import Annotator, colors, save_one_box
from main_app.yolov5.utils.torch_utils import copy_attr, smart_inference_mode
...
class Conv(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, d=1, act=True):
        ...
        self.act = self.act if act is True else act if isinstance(
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=torch.device('cpu'), dnn=False, data=None, fp16=False, fuse=True):
        ...
        pt, jit, onnx, xml, engine, coreml, saved_model, pb, tflite, edgetpu, tfjs, paddle = self._model_type(
            w)  # type
    ...
    def _model_type(p='path/to/model.pt'):
        ...
        pt, jit, onnx, xml, engine, coreml, saved_model, pb, tflite, edgetpu, tfjs, paddle, xml2 = (
            s in p for s in sf)
