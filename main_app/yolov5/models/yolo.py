...
from main_app.yolov5.utils.torch_utils import (fuse_conv_and_bn, initialize_weights, model_info, profile, scale_img, select_device,
                                                  time_sync)
from main_app.yolov5.utils.plots import feature_visualization
from main_app.yolov5.utils.general import LOGGER, check_version, check_yaml, make_divisible, print_args
from main_app.yolov5.utils.autoanchor import check_anchor_order
from main_app.yolov5.models.experimental import *
from main_app.yolov5.models.common import *
import argparse
import contextlib
import os
import platform
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    anchors, nc, gd, gw, act = d['anchors'], d['nc'], d['depth_multiple'], d['width_multiple'], d.get(
        'activation')
    if act:
        # redefine default activation, i.e. Conv.act = nn.SiLU()
        Conv.act = eval(act)
